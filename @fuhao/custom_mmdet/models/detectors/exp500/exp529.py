...
class CascadeRCNN_custom529(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(CascadeRCNN_custom529, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=rpn_head,
            roi_head=roi_head,
    ...
    def show_result(self, data, result, **kwargs):
        ...
        return super(CascadeRCNN_custom529, self).show_result(data, result, **kwargs)
